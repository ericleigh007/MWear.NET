...
namespace MetaWearTest
{
    ...
    public sealed partial class HubPage : Page
    {
        ...
        {
            if (GenericBTHLEService.Instance.IsServiceInitialized)
            {
                foreach (var measurement in GenericBTHLEService.Instance.DataPoints)
                {
            ...
            GenericBTHLEService.Instance.ValueChangeCompleted += Instance_ValueChangeCompleted;
